    ...
    <div className="login-form">
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  ...
                  <div className="relative inline-flex flex-col">
                    {!isSubmitted? <img className="md:max-w-none mx-auto rounded" src={require('../images/farmer.jpg').default} width="500" height="462" alt="Features bg" />:<div> <div style={{marginTop:"0%"}} className="max-w-3xl mx-auto mt-20" data-aos="zoom-y-out">
      <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
        ...
        <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
          ...
          <div className="text-gray-600">
          Your respected interest rate is{final} Rupees.<br/>  Please fill in all details for us to hear you.Thank you for trust in us .<br/>
