      ...
      <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
        ...
        <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
          ...
          <blockquote className="text-xl font-medium mb-4">
            “ Krishi Seva which is Inspired from the Slogan of JAI JAWAN ,JAI KISAN. Countey Needs a Solider Who Secures nation at Border also a Farmer who Secures by producing food.Where as Farmer is Not less than a Solider.But that Farmer is being neglected  in our society .So ,We as a Agriculture Students feel Responsible to help farmers with the help of Youth and Expertise of agriculture .  “
          </blockquote>
          <cite className="block font-bold text-lg not-italic mb-1"></cite>
          <div className="text-gray-600">
            <span>Started in 2021</span> <a className="text-blue-600 hover:underline" href="#0">-Krishi Seva</a>
          </div>
        </div>
